...
function AboutSection() {
  return (
    <section className="py-24 px-8" style={{ backgroundColor: '#18181f' }}>
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="relative w-full lg:w-1/2 flex-shrink-0">
          ...
          <img
            src={about2}
            alt="معدات نيدال"
            className="absolute -bottom-8 -left-8 w-48 md:w-64 rounded-lg border-4 border-[#0c0c0f] object-cover"
